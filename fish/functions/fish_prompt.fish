...
function fish_prompt
  ...
  test $status -ne 0;
    and set last_status_colors 666 aaa f02093
    or set last_status_colors 666 aaa 03adf1
  ...
  # CHANGED: Reverses the middle char to make a fish =)
  echo -n (set_color $last_status_colors[1])">"
  echo -n (set_color $last_status_colors[2])"<"
  echo -n (set_color $last_status_colors[3])">"  
